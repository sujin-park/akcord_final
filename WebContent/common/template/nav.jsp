   ...
   <div class="panel-group">
         ...
         <div id="collapse-1" class="panel-collapse collapse">
             <div class="input-group">
                  <input type="text" class="form-control" placeholder="단어를 입력해주세요" size="30">
            ...
            <ul class="list-group">
               <li class="list-group-item">
                  ...
                  <div class="list-heading1">
                     <h4 class="list-title" style="padding-top:20px;">
                        <a href="${root}/in/list.akcord?major_id=${user.major_id}&pg=1"><i class="fa fa-question-circle-o"></i>&nbsp;지식인</a>
                     </h4>
                  </div>
                     <div class="list-heading">
                     <h4 class="list-title">
         ...
         <div class="col-sm-3">
           ...
           <div class="c_01 c">
            ...
            <div class="c_03 c pull-right" style="padding-right:80px;">
               ...
               <a href=""><span class="fa fa-bell fa-2x" style="color:#d34e4c;"></span><span class="badge">5</span></a>
           </div>
           <div class="login_info pull-right">
                 박수진님 환영합니다
                 
           <div><a href="${root}/user/logout.akcord">로그아웃</a></div>
           </div>
       </div>       
   </div>
