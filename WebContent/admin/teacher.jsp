                   ...
                   <label class="col-sm-3 control-label">그래프형식</label>
                       ...
                       <div class="col-sm-8">
                           <select id="chart_type" name="chart_type" class="form-control">
                              <option value="1">bar 그래프
                              <option value="2">doughnut 그래프
                              <option value="3">line 그래프
                              <option value="4">polarArea 그래프
                                 <!-- <option value="5">버블차트 -->
                           </select>
                       </div>
                   </div>
             ...
             <form class="form-horizontal" action="" id="dateForm" name="dateForm" >
                ...
                <div class="form-group">
                   <label class="col-sm-3 control-label">주제</label>
                       ...
                       <div class="col-sm-8">
                           <input type="text" name="question" id="question" class="form-control"  readonly="readonly">
                       </div>
                   </div>
                 <div class="form-group">
                   <label class="col-sm-3 control-label">문항</label>
