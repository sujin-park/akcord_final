...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ce7904fc14ee11cd832eb0acb92d2713&libraries=services"></script>
				...
				<div class="option">
					<div>
						<form onsubmit="searchPlaces(); return false;">
							<label>키워드 : </label><input type="text" value="" id="keyword" size="15">
...
function displayPlaces(places) {
	...
	for (var i = 0; i < places.length; i++) {
		...
		placeX.push(places[i].x);
		placeY.push(places[i].y);
...
//			    alert(placeY);
//			    alert(placeX);
			    location.href="${root}/cafe/map.akcord?placeY=" + placeY + "&placeX=" + placeX + "&i=" + i;
			});
...
// 인포윈도우에 장소명을 표시합니다
function displayInfowindow(placePosition, marker, title) {
