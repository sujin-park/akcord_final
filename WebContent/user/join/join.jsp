...
<!-- 회원가입 Modal-->
<div class="modal fade" id="joinBtnModal" role="dialog"  data-backdrop="static" data-keyboard="true" aria-hidden="true" >
            ...
            <form class="form-horizontal" id="joinForm" name="joinForm" method="post" action="">
               <fieldset>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-3">
                        <select class="form-control" id="birth1" name="birth1" onkeyup="" >
                     ...
                     <div class="col-sm-3">
                        <select class="form-control" id="birth3" name="birth3" onkeyup="" >
